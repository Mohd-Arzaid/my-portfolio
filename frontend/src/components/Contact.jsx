        ...
        <div className="main-layout bg-[#EDEDED]  lg:mx-0 flex-1 border-2 border-white  lg:rounded-[1.5rem] pb-32 md:pb-0 lg:mb-0 lg:h-[37rem] lg:overflow-auto">
            <div className="flex justify-center m-5 items-center gap-5 flex-col" id="contact">
                ...
                <span className=" font-normal text-sm md:text-lg text-center">
                    ...
                    <a className=" text-blue-500 font-bold" href="https://x.com/BharadeHarshad" target="_blank">
                        Twitter
                    </a>{" "}
                    if that&apos;s more your speed.
                </span>
                <a href="mailto:harshadbharade8@gmail.com?body=Hello" target="_blank" className="flex items-center gap-2 text-xl font-medium">
                    <MailPlus /> harshadbharade8@gmail.com
                </a>
