...
const projectsData = [
  {
    ...
    title: "StudyNotion",
    description:
      "An Ed-Tech platform for users to create, enroll in, and rate educational content.",
  ...
  },
  {
    ...
    title: "Food App",
    description:
      "A responsive food ordering website with advanced search, Stripe payment integration.",
  ...
  },
  {
    ...
    techStackMobile: ["React", "TailwindCss", "Framer-Motion"],
  },
  {
    id: 5,
    title: "Auth Flow",
