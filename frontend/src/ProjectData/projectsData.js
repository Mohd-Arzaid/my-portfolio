...
const projectsData = [
    ...
    },
    {
      id: 2,
      title: "Food App",
      description: "Food Hub: A responsive food ordering website with advanced search, Stripe payment integration, and user authentication.",
      categories: ["Full Stack","Backend", "Frontend", "Landing Pages"],
    ...
    },
    {
...

      {
        ...
        description: "A Task management app that lets users register, manage, create, update, and delete tasks",
        categories: ["Full Stack","Backend", "Frontend", "Landing Pages"],
        imageUrl: "./assets/Project4.png",
        techStack: ["MongoDB", "ExpressJS", "React", "Redux", "NodeJs"],
      },
